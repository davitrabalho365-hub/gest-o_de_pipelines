...
3. Monte o relatório só com **vencidos + vencendo hoje** (em dia fica de fora): vencidos primeiro, do atraso mais antigo para o mais recente. Entregue no formato de saída do AGENTE-cadencias.md: tabela (Lead | Cadência | Vencimento) + um parágrafo de até 250 caracteres com o ponto crítico do dia — nada de texto corrido além disso.
